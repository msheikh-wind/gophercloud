...
func interfaceUpdateRequired(info starlingxv1.CommonInterfaceInfo, iface *interfaces.Interface, profile *starlingxv1.HostProfileSpec, host *v1info.HostInfo) (opts interfaces.InterfaceOpts, result bool) {
	...
	if (info.MaxTxRate == nil && iface.MaxTxRate != nil) || (info.MaxTxRate != nil && iface.MaxTxRate == nil) || (info.MaxTxRate != nil && *info.MaxTxRate != *iface.MaxTxRate) {
		opts.MaxTxRate = info.MaxTxRate
		result = true
	}

	if (info.MaxRxRate == nil && iface.MaxRxRate != nil) || (info.MaxRxRate != nil && iface.MaxRxRate == nil) || (info.MaxRxRate != nil && *info.MaxRxRate != *iface.MaxRxRate) {
